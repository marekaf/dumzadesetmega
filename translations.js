...
const TRANSLATIONS = {
  ...
  en: {
    ...
    'sankey.node.0': 'Employer total cost',
    'sankey.node.1': 'Income tax',
    'sankey.node.2': 'Social + health',
    'sankey.node.3': 'Net salary',
    'sankey.node.4': '30 years of mortgage payments',
    'sankey.node.5': 'Down payment',
    'sankey.node.6': 'Build phase + project',
    'sankey.node.7': 'Property tax 30 years',
    'sankey.node.8': 'Interest to bank',
    'sankey.node.9': 'Build price (purchase)',
    ...
    'sankey.node.15': 'Real value of build',
    'sankey.node.16': 'Real value of project',
